    ...
    const CTASection: React.FC = () => {
        return (
            ...
            >
                <div 
                    className="w-[1139px] h-[337px] mx-auto rounded-2xl p-8 md:p-12 relative overflow-hidden"
                    style={{
                        background: '#232D62',
                ...
                >
                    ...
                    <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-12 text-center lg:text-left h-full">
